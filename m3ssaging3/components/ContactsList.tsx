...
const ConversationTile = ({
  ...
  const latestMessage = "CONTACT NAME"
  const path = `/contacts/${conversation.peerAddress}`
      ...
      <a onClick={onClick}>
        ...
        >
          ...
          <div className="py-4 sm:text-left text w-full">
            ...
            <p
              className={classNames(
                'text-[16px] md:text-sm font-normal text-ellipsis mt-0',
    ...
    <div className="flex flex-col flex-grow justify-center h-[100%]">
      <div className="flex flex-col items-center px-4 text-center">
        ...
        <p className="text-lx md:text-md text-n-200 font-normal">
          There are no contacts for this address
        </p>
      </div>
    </div>
  )
